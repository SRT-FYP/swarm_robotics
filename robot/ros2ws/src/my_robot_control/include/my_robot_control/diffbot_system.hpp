...
private:
  ...
  double hw_stop_sec_;
  std::unique_ptr<PiMotorDriver> motor_driver_;
  int left_motor_pwm_pin_;
  int left_motor_forward_pin_;
  int left_motor_backward_pin_;
//   int left_encoder_pin_;
  int right_motor_pwm_pin_;
  int right_motor_forward_pin_;
  int right_motor_backward_pin_;
